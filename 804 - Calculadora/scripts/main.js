...
function main() {
    ...
    function multiply() {
        let firstNumber = Math.floor(Math.random() * (100 - 0+1)) + 0;//Number(inputFirstNumber.value);
        let secondNumber = Math.floor(Math.random() * (100 - 0+1)) + 0;//Number(inputSecondNumber.value);
